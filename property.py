...
class Property():
  def __init__(self, name, siteColor, rent, house, house2, house3, house4, hotel, mortgage, mortgagePrice, cost, image=None):
    self.name=name
    self.owner=None
    self.siteColor=siteColor
    self.rent=[rent,rent*2,house,house2,house3,house4,hotel]
    self.mortgage = mortgage
    self.mortgageP = mortgagePrice 
    self.costHouse=cost
    self.upgrades = 0
...
MedAve = Property('Mediterranean Avenue', "Brown", 2, 10, 30, 90, 160, 250, False,30,  50, MA)
BalAve = Property('Baltic Avenue',"Brown", 4, 20, 60, 180, 320, 450, False,30, 50, BA)
ReadRail = Property("Reading Railroad", "Black", 25, 0, 0, 0, 0, 0, False,100, 0,RR)
OrAve = Property('Oriental Avenue', "Light Blue", 6, 30, 90, 270, 400, 550,False, 50, 50, OA)
VerAve = Property('Vermont Avenue', "Light Blue", 6, 30, 90, 270, 400, 550, False,50, 50, VA)
ConAve = Property( 'Connecticut Avenue', "Light Blue", 8, 40, 100, 300, 450, 600,False,60, 50, CA)
StChar = Property('St. Charles Place', "Pink",10, 50, 150, 450, 625, 750,False,70, 100, SC)
EleComp = Property("Electric Company", "Utility", 0, 0, 0,0, 0,0,False,75,0,EC)
StaAve = Property( 'States Avenue', "Pink", 10, 50, 150, 450, 625, 750, False,70, 100, SA)
VirAve = Property('Virginia Avenue', "Pink", 12, 60, 180, 500, 700, 900, False,80, 100, VirA)
PennRail = Property("Pennsylvania Railroad", "Black", 25, 0,0,0,0,0,False,100, 0, PR)
StJames = Property('St. James Place', "Orange", 14, 70, 200, 550, 750, 950,False, 90, 100,JP)
TenAve = Property('Tennessee Avenue', "Orange", 14, 70, 200, 550, 750, 950,False, 90, 100, TA)
NewAve = Property('New York Avenue', "Orange" ,16, 80, 220, 600, 800, 1000, False,100, 100,NYA)
KenAve = Property('Kentucky Avenue', "Red", 18, 90, 250, 700, 875,	1050,False, 110, 150,KA)
IndAve = Property('Indiana Avenue', "Red", 18,90, 250, 700, 875, 1050,False, 110, 150,IA)
IllAve = Property('Illinois Avenue',"Red", 20,  100, 300, 750, 925, 1100, False,120,150,IL)
BNORail = Property("B. & O. Railroad", "Black", 25, 0, 0, 0, 0, 0, False,100, 0,BNO)
AtlAve = Property('Atlantic Avenue',"Yellow", 22,  110, 330, 800, 975, 1150,False, 130,150,AA)
VenAve = Property('Ventnor Avenue', "Yellow", 22, 110, 330, 800, 975, 1150,False, 130, 150,VET)
WaterWorks = Property("Water Works", "Utility", 0, 0, 0,0, 0,0,False,75,0, WW)
MarGar = Property('Marvin Gardens', "Yellow", 24, 120, 360, 850, 1025, 1200,False, 140, 150,MG)
PacAve = Property('Pacific Avenue', "Green", 26, 130, 390, 900, 1100, 1275,False,150, 200,PA)
NorAve = Property('North Carolina Avenue', "Green", 26, 130, 390, 900, 1100, 1275,False, 150, 200,NC)
ShortLine = Property("Short Line", "Black", 25, 0, 0, 0, 0, 0, False,100, 0,SL)
PenAve = Property('Pennsylvania Avenue', "Green", 28, 150, 450, 1000, 1200, 1400, False,160, 200,Penn)
ParkPlace = Property('Park Place', "Dark Blue", 35, 175, 500, 1100, 1300, 1500,False, 175, 200,PP)
Boardwalk = Property('Boardwalk',"Dark Blue", 50, 200, 600, 1400, 1700, 2000, False,200, 200,B)
